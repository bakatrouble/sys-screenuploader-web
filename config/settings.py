...
if not DEBUG:
    ...
    AWS_ACCESS_KEY_ID = env.str('AWS_ACCESS_KEY_ID')  # 'AKIAJYKVGJHIKT5UIQMQ'
    AWS_SECRET_ACCESS_KEY = env.str('AWS_SECRET_ACCESS_KEY')  # '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'
